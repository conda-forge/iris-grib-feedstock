About iris-grib-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/iris-grib-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/SciTools/iris-grib

Documentation: https://iris-grib.readthedocs.io
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3941&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/iris-grib-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `iris-grib` can be installed with `conda`:
...
It is possible to list all of the versions of `iris-grib` available on your platform with `conda`:
...
```
mamba search iris-grib --channel conda-forge
```
...
mamba repoquery search iris-grib --channel conda-forge

# List packages depending on `iris-grib`:
mamba repoquery whoneeds iris-grib --channel conda-forge

# List dependencies of `iris-grib`:
mamba repoquery depends iris-grib --channel conda-forge
```
